...
The baseline that HF-only tools can complete.
...
- Question raised by the audit: **is QJL actually helping?** (One PyTorch port reports
...
Relabel note: `behavior_divergence` measures T1 degradation, not T2.
